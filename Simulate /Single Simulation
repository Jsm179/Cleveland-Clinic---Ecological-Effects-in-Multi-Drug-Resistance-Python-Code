...
def main():
    ...
    x_conc = 150  #intial Drug 1 concentraction (between 0 to 200)
    y_conc = 150 #intial Drug 2 concentraction (between 0 to 200)
    eco_effect1 = 1
    eco_effect2 = 1.3
    eco_effect3 = 0.25
    eco_effect4 = 1 #Ecological effect (<1 is positive game, =1 no game, >1 is negative game)
...
class DrugLandscape:
    ...
    def simulate(self, mean, eco_effect, cov, timesteps, popsize, time, mutantfreq, x_conc, y_conc):
        ...
        dt = (t[1]- t[0])/2                 #Can adjust differentiation parameter as necessary: used to calculate derivative using np.gradient below
        ...
        #Calulates the integral of the mean alpha and beta to recover the mean trajectory
        ...
        #Calculates the gradients the mean alpha and beta based on 
